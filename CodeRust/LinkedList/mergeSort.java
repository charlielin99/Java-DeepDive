class mergeSort{
  ...
  public static void split_in_half(LinkedListNode head, Pair<LinkedListNode,LinkedListNode> first_second) {
  ...
  public static LinkedListNode merge_sorted_lists(LinkedListNode first, LinkedListNode second) {
